...
AST *	ResumeForAction::eval( AST * a )
	{
		// Note: A616 training document , written by Boeing is wrong.
		// It states that resume does cause another iteration
		// WITHOUT incrementing the loop variable. It does....
