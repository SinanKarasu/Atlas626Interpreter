...
class	MeasuredCharacteristicMnemonicType : public ModifierType{
	public:
		MeasuredCharacteristicMnemonicType
			( ANTLRTokenPtr p , ModifierEntry * m,RWCString & left,class AtlasParser * parser=0);
		virtual RWCString       getName() const;
		virtual Long		compare	( AST * o ) const;
		virtual AST 	*	check	( AST * a=0 );
		virtual	AST *	data	( AST * a = 0 );
	...
	protected:
		...
		RWCString pulse_sfx;
		RWCString ratio;
		enum Suffix { ParamSuffix,AndAmplSuffix,AmplSuffix,PhaseSuffix,RatioSuffix};
...
class	TedlCharacteristicMnemonicType : public CharacteristicMnemonicType{
	public:
		TedlCharacteristicMnemonicType
			( ANTLRTokenPtr p , ModifierEntry * m,RWCString & left,class AtlasParser * parser=0);
